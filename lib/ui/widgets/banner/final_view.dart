...
import 'package:rusa_application/ui/widgets/banner/data.dart';
import 'package:rusa_application/ui/widgets/banner/image_viewer.dart';
        ...
        children: [
          Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                      spreadRadius: 3, blurRadius: 15, color: Colors.black45)
                ],
                color: mainColor,
              ),
              child: Row(
